 ...
 *
 */
$drupal_hash_salt = 'KRV-D1rGo22nL9jHzgZcDkW89a_xAqWqJX8pH4XUWu8';
...
/**
 * Set settings.php to search for local.settings.php in order to avoid
 * problems with committing settings.php to git
 */
