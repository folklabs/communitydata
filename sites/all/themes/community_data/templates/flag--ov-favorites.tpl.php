...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
    <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" rel="nofollow"<?php print $link_text; ?>><button type="button" class="btn btn-default <?php print $flag_classes ?>"><span class="flag-throbber">&nbsp;</span></button></a>
  <?php else: ?>
