...
angular.module('duconfig', [])
    //.constant('baseURL', 'http://0.0.0.0:6543');
    .constant('baseURL', 'http://lambeth.dataunityapp.com');

angular.module('dataunity-hydra', ['duconfig'])
    ...
    .controller('HydraCtrl', function($scope, $sce, $http, jsonldHelper, rdfsNs, hydraNs, baseURL) {
        // Dependencies
        var jsonLd = jsonld,
                ...
                .success(function (data, status, headers, config) {
                    ...
                    jsonldPromises.expand(data)
                        .then(function (expanded) {
                            ...
                            var apiDocURL = baseURL + '/hydra/api-doc';
                            //var apiDocURL = 'http://lambeth.dataunityapp.com/hydra/api-doc';
        ...
        $scope.initPage = function () {
            // Load the page for the first time using config values
            $scope.loadPage(baseURL + '/hydra/entrypoint');
        };
